...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)] font-body text-[var(--color-foreground)]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-stone-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-2 flex justify-between items-center">
          <a href="#" className="flex items-center gap-2">
            <Image src="/GC_logo.png" alt="GC Auto" width={38} height={50} className="object-contain" />
      ...
      {/* Hero */}
      <section className="pt-28 pb-16 px-4 bg-gradient-to-b from-teal-50 to-stone-50">
        <div className="max-w-6xl mx-auto text-center">
          <Image src="/GC_logo.png" alt="GC Auto" width={96} height={128} className="mx-auto mb-6 object-contain" />
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="#contact" className="bg-[var(--color-primary)] text-white px-8 py-3 rounded-full font-semibold hover:bg-[var(--color-primary-dark)] transition-colors">
              Book a Repair
            </a>
            <a href="#fleet" className="bg-slate-800 text-white px-8 py-3 rounded-full font-semibold hover:bg-slate-900 transition-colors">
              Rent a Car
            </a>
            <a href="#used-cars" className="bg-[var(--color-accent)] text-white px-8 py-3 rounded-full font-semibold hover:bg-amber-700 transition-colors">
              Browse Used Cars
            </a>
          </div>
        </div>
      ...
      <section id="contact" className="py-16 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-sm border border-stone-100 space-y-4">
            ...
            <button type="submit"
              className="w-full bg-[var(--color-primary)] text-white py-3 rounded-xl font-semibold hover:bg-[var(--color-primary-dark)] transition-colors"
            >
              {bookingSent ? "✓ Sent! We'll be in touch soon" : "Submit"}
            </button>
          </form>
