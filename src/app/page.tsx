      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-stone-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 text-sm font-medium">
            <a href="#services" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">Services</a>
            <a href="#fleet" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">Rentals</a>
            <a href="#used-cars" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">Buy</a>
            <a href="/about" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">About</a>
            <a href="#chat" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">AI Chat</a>
            <a href="#contact" className="hover:text-[var(--color-primary)] hover:underline underline-offset-4">Contact</a>
          </div>
